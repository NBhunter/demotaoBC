			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6 pt-2 pt-lg-0 mt-4 mt-lg-0">
						<div id="map" class="contact_map2" data-zoom="14" data-latitude="10.370575" data-longitude="105.431131" data-icon="<?php echo e(asset('public/assets/images/marker.png')); ?>"></div>
					</div>
				</div>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\HVHL\linhtinh\wamp64\www\larashop\resources\views/frontend/lienhe.blade.php ENDPATH**/ ?>