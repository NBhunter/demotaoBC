                        ...
                        <?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="product-thumbnail"><a href="#">
                                    <img src="<?php echo e(env('APP_URL') . '/storage/app/' . $value->options->image); ?>" /></a>
                                </td>
                                <td class="product-name" data-title="Product"><a href="#"><?php echo e($value->name); ?></a></td>
                                <td class="product-price" data-title="Price"><?php echo e(number_format($value->price)); ?><sup>đ</sup></td>
                                <td class="product-quantity" data-title="Quantity">
                                    <div class="quantity">
                                        <a class="minus" href="<?php echo e(route('frontend.giohang.giam', ['row_id' => $value->rowId])); ?>" onclick="giam()">-</a>
                                ...
                                <td class="product-subtotal" data-title="Total"><?php echo e(number_format($value->price * $value->qty)); ?><sup>đ</sup></td>
                                <td class="product-remove" data-title="Remove">
                                    <a href="<?php echo e(route('frontend.giohang.xoa', ['row_id' => $value->rowId])); ?>"><i class="ti-close"></i></a>
                                </td>
                            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\HVHL\linhtinh\wamp64\www\larashop\resources\views/frontend/giohang.blade.php ENDPATH**/ ?>