			...
			<div class="container">
				<nav class="navbar navbar-expand-lg">
					<a class="navbar-brand" href="{{ route('frontend') }}">
						<img class="logo_light" src="{{ asset('public/assets/images/logo_light.png') }}" />
						<img class="logo_dark" src="{{ asset('public/assets/images/logo_dark.png') }}" />
					</a>
							...
							<li class="dropdown">
								...
								<div class="dropdown-menu">
									<ul>
										...
										<li><a class="dropdown-item nav-link nav_item" href="{{ route('frontend') }}">Danh sách sản phẩm</a></li>
										<li><a class="dropdown-item nav-link nav_item" href="{{ route('frontend.giohang') }}">Giỏ hàng</a></li>
									...
									<div class="d-lg-flex menu_banners">
										<div class="col-sm-4">
											<div class="header-banner">
												<img src="{{ asset('public/assets/images/menu_banner1.jpg') }}" />
										...
										<div class="col-sm-4">
											<div class="header-banner">
												<img src="{{ asset('public/assets/images/menu_banner2.jpg') }}" />
												<div class="banne_info">
													<h6>15% Off</h6>
													<h4>Men's Fashion</h4>
													<a href="#">Shop now</a>
										...
										<div class="col-sm-4">
											<div class="header-banner">
												<img src="{{ asset('public/assets/images/menu_banner3.jpg') }}" />
												<div class="banne_info">
													<h6>23% Off</h6>
													<h4>Kids Fashion</h4>
													<a href="#">Shop now</a>
					...
					<ul class="navbar-nav attr-nav align-items-center">
						...
						<li><a href="{{ route('khachhang') }}" class="nav-link"><i class="linearicons-user"></i></a></li>
						<li class="dropdown cart_dropdown">
							...
							<div class="cart_box dropdown-menu dropdown-menu-right">
								...
								<div class="cart_footer">
									...
									<p class="cart_buttons"><a href="{{ route('frontend.giohang') }}" class="btn btn-fill-line view-cart">GIỎ HÀNG</a>
									<a href="{{ route('frontend.dathang') }}" class="btn btn-fill-out checkout">THANH TOÁN</a></p>
								</div>
							</div>
							@endif
						</li>
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="widget">
							<div class="footer_logo">
								<a href="#"><img src="{{ asset('public/assets/images/logo_light.png') }}" /></a>
							</div>
